...
if cameraActiveMsg.Data
    % Capture and save image from the camera
    disp('Capturing and saving image...');
    try
        ...
        folderName = "C:\Users\fazal\OneDrive\Documents\University of Michigan\Thesis\Matlab Codes\Dataset\Cylinder";
        ...
        fileName = fullfile(folderName, ['image_', timestamp, '.jpg']);
